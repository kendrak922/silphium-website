...
use BitCode\BitFormPro\Dependencies\Mpdf\PsrLogAwareTrait\MpdfPsrLogAwareTrait;
...
class Mpdf implements \BitCode\BitFormPro\Dependencies\Psr\Log\LoggerAwareInterface
{
	...
	/**
	 * @var \BitCode\BitFormPro\Dependencies\Mpdf\Http\ClientInterface
	 */
	private $httpClient;

	/**
	 * @var \BitCode\BitFormPro\Dependencies\Mpdf\File\LocalContentLoaderInterface
	 */
	private $localContentLoader;

	/**
	 * @var \BitCode\BitFormPro\Dependencies\Mpdf\AssetFetcher
	 */
	...
	/**
	 * @var \BitCode\BitFormPro\Dependencies\Mpdf\Container\ContainerInterface
	 */
	private $container;

	/**
	 * @param mixed[] $config
	 * @param \BitCode\BitFormPro\Dependencies\Mpdf\Container\ContainerInterface|null $container Experimental container to override internal services
	 */
